...
%% Topmatter.
\title{\emph{Compiler Generation}\\Using \HAX\version}
...
{
  //\text{\it\color{blue}Lexical Analysis}
  //\text{\it\color{blue}Syntax Analysis}
  //\text{\it\color{blue}Semantic Analysis}
  //\text{\it\color{blue}Code Generator}
  //\text{\it\color{blue}Main}
}
\end{hacs}
