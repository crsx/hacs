...
energon1[~]$ ^textcolor{blue}{^texttt{wget http://crsx.org/hacs-0.9.zip}}
energon1[~]$ ^textcolor{blue}{^texttt{unzip hacs-0.9.zip}}
energon1[~]$ ^textcolor{blue}{^texttt{cd hacs}}
energon1[hacs]$ ^textcolor{blue}{^texttt{make}}
energon1[hacs]$ ^textcolor{blue}{^texttt{make install install-support}}
\end{code}
  %%
...
HACS: Parsing .hx to term First.hxraw...
HACS: Generating environment declarations First.env...
rm First.hxraw
HACS: Parsing .hx to term /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/First.hxraw...
HACS: Generating parser generator base /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/First.prep...
HACS: Generating plain term parser generator /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/FirstParser.pg...
HACS: Generating JavaCC grammar /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/FirstParser.jj...
HACS: Generating Java parser source /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/FirstParser.java...
HACS: Compiling Java class /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/FirstParser.class...
rm /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/FirstParser.jj /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/FirstParser.pg /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/FirstParser.java /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/First.prep /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/First.hxraw
HACS: Parsing .hx to term /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/First.hxraw...
HACS: Generating parser generator base /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/First.prep...
HACS: Generating meta-source parser generator template /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/FirstHx.pgtemplate...
HACS: Generating meta-source parser generator /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/FirstHx.pg...
HACS: Generating JavaCC grammar /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/FirstHx.jj...
HACS: Generating Java parser source /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/FirstHx.java...
HACS: Compiling Java class /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/FirstHx.class...
rm /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/FirstHx.pgtemplate /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/FirstHx.jj /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/FirstHx.pg /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/First.prep /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/First.hxraw /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/FirstHx.java
HACS: Parsing .hx to term /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/First.hxraw...
HACS: Generating parser generator base /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/First.prep...
HACS: Generating embedded meta-term parser /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/FirstEmbed.pg...
HACS: Generating JavaCC grammar /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/FirstEmbed.jj...
HACS: Generating Java parser source /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/FirstEmbed.java...
HACS: Compiling Java class /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/FirstEmbed.class...
rm /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/FirstEmbed.jj /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/FirstEmbed.pg /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/First.prep /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/FirstEmbed.java /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/First.hxraw
HACS: Parsing .hx to term /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/First.hxraw...
HACS: Generating environment declarations /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/First.env...
HACS: Parsing custom HACS to term /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/First.hxprep...
HACS: Generating rewriter /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/FirstRewriter.crs...
rm /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/First.hxprep /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/First.env /home/krisrose/myfirst/build/org/crsx/hacs/tests/first/First.hxraw
HACS: Generating First.run...
...
\item The special "sugar" declaration expresses that the concrete syntax can use parentheses to
  raise the precedence of the enclosed expression to~3: it is the first example of a \emph{rewrite
    rule} with a "→" that we see, where we remark that the expression is marked "#" so we can use the
  "#" to indicate that it is extracted as the abstract result of concrete syntax with parenthesis.
  (In fact the general rule is that when an "→" is used then all sort specifiers must be
  ``disambiguated'' with distinct markers like "#" or "#5" in this way.)

\item A sort can be defined with a single "symbol" case. If so, then the actual syntax must refer to
  a single token, and that token must allow that a trailing "_"$n$ (underscore and count) is added
  to any instance (this permits automatic symbol generation).
...
\begin{hacs}
   SeA(⟦x := ⟨E#2⟩; ⟨S#3⟩⟧)  →    SeB(⟦x := ⟨E Ee(#2)⟩; ⟨S#3⟩⟧) ;
\end{hacs}
...
SeA(⟦id := ⟨Exp#1⟩; ⟨Stat#2⟩⟧) → SeB(⟦id := ⟨Exp Ee(#1)⟩; ⟨Stat#2⟩⟧);
{
  ...
  SeB(⟦id := ⟨Exp#1 ↑t(#t1)⟩; ⟨Stat#2⟩ ⟧ ↑#syn) → ⟦id := ⟨Exp#1⟩; ⟨Stat SeA(#2) ↓e{⟦id⟧:#t1}⟩⟧ ↑#syn  ;
}
