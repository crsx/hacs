...
\newcommand{\basecopyright}{\noindent
  ...
  \noindent\doclicenseImage[imagewidth=3em] Documentation is © 2011,2015 Kristoffer Rose and additionally licensed under \doclicenseNameRef.}
...
\begin{example}
  ...
  \begin{code}[commandchars=\^\{\}]
energon1[~]$ ^textcolor{blue}{^texttt{hacs LetrecMap.hx}}
…
energon1[~]$ ^textcolor{blue}{^texttt{./LetrecMap.run --scheme=Reduce --term="a:b b:c in a"}}
c
energon1[~]$ ^textcolor{blue}{^texttt{./LetrecMap.run --scheme=Reduce --term="b:c a:b in a"}}
c
  \end{code}
\end{example}
