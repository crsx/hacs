...
$ ^textcolor{blue}{^texttt{rm -fr ~/.hacs hacs}}
  \end{code}
  %%$
  ...
  %%
  \begin{code}[commandchars=\^\{\}]
$ ^textcolor{blue}{^texttt{wget http://crsx.org/hacs-^version.zip}}
$ ^textcolor{blue}{^texttt{unzip hacs-^version.zip}}
$ ^textcolor{blue}{^texttt{cd hacs}}
...
$ ^textcolor{blue}{^texttt{$HOME/.hacs/bin/hacs First.hx}}
...
\begin{example}
  ...
  \begin{code}[commandchars=\^\{\}]
$ ^textcolor{blue}{^texttt{hacs LetrecMap.hx}}
…
$ ^textcolor{blue}{^texttt{./LetrecMap.run --scheme=Reduce --term="a:b b:c in a"}}
c
$ ^textcolor{blue}{^texttt{./LetrecMap.run --scheme=Reduce --term="b:c a:b in a"}}
c
  \end{code}
\end{example}
...
\begin{example}[untyped λ calculus]
  ...
  %%
  \begin{code}[commandchars=\\\{\}]
$ \textcolor{blue}{\texttt{hacs Lambda.hx}}
…
$ \textcolor{blue}{\texttt{./Lambda.run --sort=T --term='(λx.x)y'}}
 y
  \end{code}
  %%
\end{example}
...
\begin{example}
  ...
  \begin{code}[commandchars=\\\{\}]
$ \textcolor{blue}{\texttt{hacs CPS.hx}}
…
$ \textcolor{blue}{\texttt{./CPS.run --scheme=CPS --term="(λx.x x)"}}
...
\begin{example}[string operations]
  ...
  %%
\begin{code}[commandchars=\\\{\}]
$ \textcolor{blue}{hacs MakeToken.hx}
...
$ \textcolor{blue}{./MakeToken.run --scheme=Test --term="Hello Hello Hello John"}
X_Hello_x_x_John
  \end{code}
  %%$
\end{example}
...
\begin{example}
  ...
  %%
\begin{code}[commandchars=\\\{\}]
$ \textcolor{blue}{hacs Desk.hx}
...
$ \textcolor{blue}{./Desk.run --scheme=Eval --term="1+2*3/(2-1)"}
7.0
  \end{code}
  %%$
\end{example}
...
\begin{example}[set of words]
  ...
  %%
\begin{code}[commandchars=\^\{\}]
$ ^textcolor{blue}{^texttt{hacs WordSet.hx}}
$ ^textcolor{blue}{^texttt{./WordSet.run --scheme=Check --term="a in a,b,b,a"}}
Yes, the list has a.
$ ^textcolor{blue}{^texttt{./WordSet.run --scheme=Check --term="Foo in Bar"}}
...
\begin{code}[commandchars=\^\{\}]
$ ^textcolor{blue}{^texttt{hacs WordMap.hx}}
$ ^textcolor{blue}{^texttt{./WordMap.run --scheme=Substitute --term="a:b in a b b a"}}
b b b b
$ ^textcolor{blue}{^texttt{./WordMap.run --scheme=Substitute --term="k:v in a b c"}}
a b c
\end{code}
%%$
\end{example}
...
\begin{example}[word substitution]
  ...
  %%
\begin{code}[commandchars=\\\{\}]
$ \textcolor{blue}{hacs WordSubst.hx}
$ \textcolor{blue}{./WordSubst.run --scheme=Run --term="a=1 a"}
 a=1  1   
$ \textcolor{blue}{./WordSubst.run --scheme=Run --term="b a \{a=1 b=2\}"}
 2  1   {  a=1  b=2    }     
$ \textcolor{blue}{./WordSubst.run --scheme=Run --term="\{a=1 b=2 c=3\} a b c \{a=4\} a b c"}
