...
%% Macros.
\newcommand{\HAX}{\text{H\kern-.1em A\kern-.1em CS}\xspace}
...
%% - $xx_n → \Keyword{xx}\ensuremath{_{\text{n}}}
...
\gdef\Identifier@two!1!2\lst@um_!3@{{%
  ...
  \else\ifx\1\justd@llar
    \ifx\2\empty               \Keyword{\$\3}%
    \else                      \Keyword{\expandafter\def\csname lst@um-\endcsname{\text{-}}\2\3}%
    \fi
  \else\ifx\1\just@at
    \Keyword{\expandafter\def\csname lst@um-\endcsname{\text{-}}\1\2\3}%
...
\newcommand{\kw}[1]{\textbf{\color{gray}#1}}
...
\lstdefinelanguage{HACS}{basicstyle=\fontfamily{ccr}\selectfont,%
  ...
  comment=[l]{//},morecomment=[s]{/*}{*/},commentstyle=\color{blue}\sl,%
  keywordstyle=\Keyword,%
  keywords={attribute,data,fragment,import,main,module,nested,property,rule,scheme,simplify,sort,%
    space,static,sugar,symbol,tag,token,default,error,binds,as,template,@},%
  literate=%
    ...
    {α}{{\ensuremath{\alpha}}}1 {β}{{\ensuremath{\beta}}}1 {γ}{{\ensuremath{\gamma}}}1 {λ}{{\ensuremath{\lambda}}}1 %
