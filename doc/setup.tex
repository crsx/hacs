...
%% HACS.
\lstdefinelanguage{HACS}{basicstyle=\normalsize,%
  ...
  keywords={attribute,data,fragment,import,module,nested,property,rule,scheme,simplify,sort,space,static,sugar,symbol,tag,token},%
  literate=%
