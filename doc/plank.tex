...
\newcommand{\MS}[1]{\textcolor{pink}{MS: #1}}
...
\begin{abstract}\noindent
  %%
  We present \hax (or ``plank''), a core calculus that can serve as the foundation for the \CRSX
...
\begin{definition}[\hax syntax]
  ...
  \end{itemize}
  %%
  The ``$A^{*\kw,}$'' notation means zero or more $A$s separated by commas. We shall use the
