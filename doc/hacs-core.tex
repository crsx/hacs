...
\begin{definition}[raw \HAX]
  The \HAX grammar is shown in Figure~\ref{fig:hacs}. (We call this the ``raw'' grammar because it
  ...
  \item $a,v ∈ \mathbb{V}$ stands for \emph{variable} tokens, which are lower case words like "x" or
