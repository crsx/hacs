...
\newcommand{\textcolorinput}{\color{blue}}
...
\newcommand{\commentstylecolor}{\color{blue}}
...
\lstdefinelanguage{HACS}{basicstyle=\sf,%
  ...
  comment=[l]{//},morecomment=[s]{/*}{*/},commentstyle=\commentstylecolor\rm,%
  keywordstyle=\kw,%
  keywords={as,attribute,data,fragment,global,import,include,main,module,nested,private,property,rule,%
    scheme,simplify,sort,space,static,sugar,symbol,tag,token,default,error,binds,template,variable},%
  literate=%
...
\newcounter{hacsline}
\setcounter{hacsline}{1}
\lstnewenvironment{hacs}[2][]{\Code[#2]\label{hacs:#2}\leavevmode
  \lstset{language=HACS,%
  basewidth={.53em,.43em},columns=flexible,texcl,%
  firstnumber=\thehacsline,numbers=left,numberstyle=\scriptsize,numberblanklines=false,xleftmargin=\parindent,%
  #1}\upshape}{\stepcounter{lstnumber}\vspace*{-.6em}\endCode\setcounter{hacsline}{\value{lstnumber}}}

\newcommand\inputhacs[2][]{\lstinputlisting[name=#1,language=HACS,basewidth={.53em,.43em},columns=flexible,numberstyle=\scriptsize,numberblanklines=false,xrightmargin=1pc,#1]{#2}}
\newcommand\hacsc{\lstinline[language=HACS,name=INLINE]}
\newcommand\h{\lstinline[language=HACS,name=INLINE]}
\lstMakeShortInline[language=HACS,columns=fullflexible,name=INLINE]"
